...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full px-6 md:px-8 lg:px-16 py-5 md:py-6 flex justify-between items-center z-[100] mix-blend-difference">
      <div className="font-heading text-lg md:text-xl font-bold tracking-wide">Brewed Awakening</div>
      ...
      {/* Mobile menu overlay */}
      <div
        className={`fixed inset-0 bg-dark/95 backdrop-blur-md flex flex-col items-center justify-center gap-8 transition-all duration-500 md:hidden ${
